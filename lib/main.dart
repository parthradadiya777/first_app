import 'package:first_app/Bloc%20pattern/Api/newspage.dart';
import 'package:first_app/Bloc%20pattern/Homepage.dart';
import 'package:first_app/about.dart';
import 'package:first_app/contact.dart';
import 'package:first_app/drawer.dart';
import 'package:first_app/expanded.dart';
import 'package:first_app/firebase/textform.dart';
...
import 'package:first_app/imagepicker.dart';
import 'package:first_app/inkwell.dart';
import 'package:first_app/listview.dart';
import 'package:first_app/sqllite/note.dart';
import 'package:first_app/sqllite/noteDetail.dart';
import 'package:first_app/sqllite/notelist.dart';
import 'package:first_app/tab/tabbar.dart';
import 'package:first_app/textfield.dart';
import 'package:first_app/tipical.dart';
import 'package:first_app/transform.dart';
import 'package:first_app/ui.dart';
import 'package:first_app/url_launcher.dart';
import 'package:first_app/zomato.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      theme: ThemeData(
          textTheme: TextTheme(
              headline1: TextStyle(color: Color.fromARGB(255, 251, 251, 253))),
          appBarTheme: AppBarTheme(color: Color.fromARGB(255, 0, 49, 112)),
          backgroundColor: Color.fromARGB(255, 0, 13, 83),
          iconTheme: IconThemeData(color: Color.fromARGB(255, 0, 38, 95))),
      routes: {
